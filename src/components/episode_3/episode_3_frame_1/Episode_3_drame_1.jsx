    ...
    return (
        <section ref={animItem} style={{ marginTop: "15%", scrollSnapAlign: "center" }}>
            <div className="episode_3_Frame_1">
                <motion.div className="episode_3_Frame_1_BlackWindow"
                    variants={blackContainer}
                    initial="hidden"
                    animate={visible ? "show" : "hidden"}
                >
                    <img className="episode_3_Frame_1_back"
                        src={back} alt={"back"} />
                    <img className="episode_3_Frame_1_threePersons"
                        src={threePersons} alt={"threePersons"} />
                    <img className="episode_3_Frame_1_boy"
                        src={boy} alt={"boys"} />
                    <img className="episode_3_Frame_1_girl"
                        src={girl} alt={"girl"} />
                    ...
                    <motion.img className="episode_3_Frame_1_message"
